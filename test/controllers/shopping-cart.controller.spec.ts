...
describe('Shopping Cart Controller', () => {
    ...
    it('should get cart items of user', async () => {
        const login = await request(app.getHttpServer())
            .post('/users/login')
            .send({ username: mockedUser.username, password: mockedUser.password });
    ...
    it('should updated count of cart item', async () => {
        const login = await request(app.getHttpServer())
            .post('/users/login')
            .send({ username: mockedUser.username, password: mockedUser.password });
    ...
    it('should get updated total price of cart item', async () => {
        ...
        const response = await request(app.getHttpServer())
            .patch('/shopping-cart/update-total-price/1')
    ...
    it('should delete cart item', async () => {
        ...
        await request(app.getHttpServer())
            .delete('/shopping-cart/delete-one/1')
            .set('Cookie', login.headers['set-cookie']);
